...
import Hint from "@/app/(platform)/(dashboard)/organization/[id]/_components/hint";
    ...
    <div className="space-y-4">
      ...
      <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-4 ">
        ...
        <FormPopover side="right" sideOffset={10}>
          <div
            role="button"
            className="aspect-video bg-[#F8F8F8] relative h-full w-full bg-muted rounded-sm flex flex-col gap-y-1 
